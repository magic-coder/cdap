...
public class AppFabricHttpHandler extends AbstractAppFabricHttpHandler {
  ...
  public void deleteAllApps(HttpRequest request, HttpResponder responder) throws Exception {
    appLifecycleHttpHandler.deleteApps(RESTMigrationUtils.rewriteV2RequestToV3(request), responder, Constants.DEFAULT_NAMESPACE);
  }
  ...
  public void listApps(HttpRequest request, HttpResponder responder) throws NamespaceNotFoundException {
    appLifecycleHttpHandler.listApps(RESTMigrationUtils.rewriteV2RequestToV3(request), responder, Constants.DEFAULT_NAMESPACE);
  }
  ...
  public void getApp(HttpRequest request, HttpResponder responder,
    ...
    appLifecycleHttpHandler.getApp(RESTMigrationUtils.rewriteV2RequestToV3(request), responder, Constants.DEFAULT_NAMESPACE, appId);
  }
