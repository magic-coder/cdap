...
public class DefaultStore implements Store {
    ...
    try {
      txnl.execute(new TransactionExecutor.Function<AppMds, Void>() {
        ...
        public Void apply(AppMds mds) throws Exception {
          ...
          replaceAppSpecInProgramJar(program, newAppSpec, ProgramType.valueOf(spec.getProgram().getProgramType().name()));
  ...
  public void addAdapter(final Id.Namespace id, final AdapterSpecification adapterSpec) {
    final Id.Adapter adapter = Id.Adapter.from(id, adapterSpec.getName());
    txnl.executeUnchecked(new TransactionExecutor.Function<AppMds, Void>() {
      @Override
      public Void apply(AppMds mds) throws Exception {
  ...
  @Nullable
  @Override
  public AdapterSpecification getAdapter(final Id.Adapter adapter) {
  ...
  @Nullable
  @Override
  public AdapterStatus getAdapterStatus(final Id.Adapter adapter) {
  ...
  @Nullable
  @Override
  public AdapterStatus setAdapterStatus(final Id.Adapter adapter, final AdapterStatus status) {
    return txnl.executeUnchecked(new TransactionExecutor.Function<AppMds, AdapterStatus>() {
      @Override
      public AdapterStatus apply(AppMds mds) throws Exception {
  ...
  @Override
  public void removeAdapter(final Id.Adapter adapter) {
    txnl.executeUnchecked(new TransactionExecutor.Function<AppMds, Void>() {
      @Override
      public Void apply(AppMds mds) throws Exception {
