...
public final class ConnectionConfig {
  ...
  public ConnectionConfig(String user, boolean sslEnabled, String hostname, int port, String namespace,
  ...
  public void setSSLnabled(boolean sslEnabled) {
    this.sslEnabled = sslEnabled;
  }
  ...
  public static final class Builder {
    ...
    public Builder(ConnectionConfig config) {
    ...
    public ConnectionConfig build() {
      return new ConnectionConfig(user, sslEnabled, hostname, port.or(sslEnabled ? DEFAULT_SSL_PORT : DEFAULT_PORT),
